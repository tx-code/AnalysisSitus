...
#-------------------------------------------------------------------------------
function (ASITUS_RETRIEVE_VERSION VERSION_FILE MAJOR MINOR)
  file(STRINGS ${VERSION_FILE} VERSION_FILE_DATA)
  foreach (line ${VERSION_FILE_DATA})
    string(REGEX MATCH "ASITUS_VERSION_YEAR *([0-9])*" match ${line})
    ...
    string(REGEX MATCH "ASITUS_VERSION_NUM *([0-9])*" match ${line})
    if (NOT "${match}" STREQUAL "")
      separate_arguments(match)
      list(GET match 1 num)
