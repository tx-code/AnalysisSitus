  ...
  if (WIN32)
    foreach (LIB IN LISTS ${LIBRARIES_LIST_NAME})
      ...
      if (NOT BUILD_SDK_ONLY)
        ...
        install (FILES "${3RDPARTY_${3RDPARTY_NAME}_DLL_DIR_DEBUG}/${LIB}${LIBRARY_NAME_DEBUG_SUFFIX}.dll" DESTINATION bini CONFIGURATIONS RelWithDebInfo OPTIONAL)
        install (FILES "${3RDPARTY_${3RDPARTY_NAME}_DLL_DIR_DEBUG}/${LIB}${LIBRARY_NAME_DEBUG_SUFFIX}.pdb" DESTINATION bini CONFIGURATIONS RelWithDebInfo OPTIONAL)
