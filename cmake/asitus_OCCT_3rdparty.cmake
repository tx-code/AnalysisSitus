...
if (NOT BUILD_ALGO_ONLY)
  if (WIN32)
    ...
    install (FILES ${3RDPARTY_tcl_DIR}/bin/tk86.dll CONFIGURATIONS Release        DESTINATION bin)
    install (FILES ${3RDPARTY_tcl_DIR}/bin/tk86.dll CONFIGURATIONS RelWithDebInfo DESTINATION bini)
    install (FILES ${3RDPARTY_tcl_DIR}/bin/tk86.dll CONFIGURATIONS Debug          DESTINATION bind)
    ...
    install (FILES ${3RDPARTY_tcl_LIBRARY_DIR}/libtk8.6.so DESTINATION bin)
  endif()
endif()
