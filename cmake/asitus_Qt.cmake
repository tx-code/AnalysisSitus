...
if (NOT BUILD_ALGO_ONLY)
  if (WIN32)
    ...
    install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5Cored.dll    CONFIGURATIONS RelWithDebInfo DESTINATION bini)
    install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5Guid.dll     CONFIGURATIONS RelWithDebInfo DESTINATION bini)
    install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5Widgetsd.dll CONFIGURATIONS RelWithDebInfo DESTINATION bini)
    install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5Svgd.dll     CONFIGURATIONS RelWithDebInfo DESTINATION bini)
    install (FILES ${3RDPARTY_QT_DIR}/bin/Qt5Networkd.dll CONFIGURATIONS RelWithDebInfo DESTINATION bini)
