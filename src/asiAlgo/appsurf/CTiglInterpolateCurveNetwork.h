 ...
 */
class CTiglInterpolateCurveNetwork : public ActAPI_IAlgorithm
{
public:
    /**
...
asiAlgo_EXPORT Handle(Geom_BSplineSurface) curveNetworkToSurface(const std::vector<Handle(Geom_Curve)>& profiles,
                                                              const std::vector<Handle(Geom_Curve)>& guides,
