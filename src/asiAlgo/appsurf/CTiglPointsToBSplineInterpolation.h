...
{
public:
    asiAlgo_EXPORT CTiglPointsToBSplineInterpolation(const Handle(TColgp_HArray1OfPnt) & points,
    ...
    asiAlgo_EXPORT Handle(Geom_BSplineCurve) Curve() const;

    asiAlgo_EXPORT operator Handle(Geom_BSplineCurve)() const;

    /// Returns the parameters of the interpolated points
    asiAlgo_EXPORT const std::vector<double>& Parameters() const;

    /// Returns the degree of the b-spline interpolation
    asiAlgo_EXPORT unsigned int Degree() const;
