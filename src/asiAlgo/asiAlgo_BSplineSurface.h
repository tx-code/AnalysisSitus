...
#ifndef _asiAlgo_BSplineSurface_HeaderFile
#define _asiAlgo_BSplineSurface_HeaderFile
...
class asiAlgo_BSplineSurface;
DEFINE_STANDARD_HANDLE(asiAlgo_BSplineSurface, Geom_BoundedSurface)
...
class asiAlgo_BSplineSurface : public Geom_BoundedSurface
{
...
public:
  ...
  DEFINE_STANDARD_RTTIEXT(asiAlgo_BSplineSurface,Geom_BoundedSurface)
