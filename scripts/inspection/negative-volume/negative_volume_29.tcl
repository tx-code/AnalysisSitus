...
test-check-solids-volumes 1.0e-4 163917.38672521504 

test-check-number-shape-entities -vertex 107 -edge 166 -wire 61 -face 61 -shell 1 -solid 1 -compsolid 0 -compound 0
